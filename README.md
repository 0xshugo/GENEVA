...
GENEVA（Generative Ethics Validator）は、生成コンテンツの倫理面をサポートするためのテキストおよび画像類似度チェッカーです。AIによる繰り返しの検出や、画像のpHash比較など、教育・研究・クリエイティブ制作のワークフローを支援します。本READMEは本ソフトウェアの機能と利用方法を説明するためのものです。
